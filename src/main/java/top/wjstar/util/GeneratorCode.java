...
public class GeneratorCode {
    private static final String author = "wxvirus";//作者名称
    private static String outputDir = "";//生成的位置  到 项目目录下的 src/main/java/ 即可 加 / 结尾
    private static String driver = "com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url = "jdbc:mysql://localhost:3306/db_authority_system?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
    ...
    private static String parentPackage = "top.wjstar";//顶级包结构
